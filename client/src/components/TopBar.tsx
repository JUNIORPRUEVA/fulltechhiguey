          ...
          {isAuthenticated && customer && (
            ...
            >
              ...
              <div className="hidden md:block">
                ...
                <p className="text-slate-600 text-xs">Cliente FULLTECH</p>
              </div>
            </button>
          )}
          ...
          {(isAuthenticated || isAdminAuthenticated) ? (
            ...
            <>
              ...
              <div className="pt-4 border-t border-white/10 space-y-3">
                <button
                  className="w-full flex items-center gap-4 p-4 bg-gradient-to-r from-orange-500/20 to-red-600/20 hover:from-orange-500/30 hover:to-red-600/30 rounded-xl transition-all duration-100 border border-orange-500/30"
                  onClick={createInstantClickHandler(() => {
                    closeMenu();
                    navigateInstantly("/admin/login");
                  })}
                  onMouseEnter={onMouseEnterPreload('/admin/login')}
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <p className="text-white font-medium">Acceso Administrador</p>
                    <p className="text-white/60 text-sm">Sistema de usuarios deshabilitado</p>
                  </div>
                  <i className="fas fa-chevron-right text-white/40" />
                </button>
              </div>
