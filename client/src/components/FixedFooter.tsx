...
export function FixedFooter() {
  ...
  const handleWhatsAppShare = () => {
    const message = `¡Descubre los mejores productos tecnológicos en FULLTECH! 🚀\n\nVisita nuestra tienda física: https://maps.app.goo.gl/r27u2URmmAyWZyfv6\n\n${window.location.origin}`;
      ...
      <div className="max-w-full mx-auto px-3 md:px-4">
        ...
        <div className={`${isExpanded ? 'py-2' : 'py-3 md:py-4'} transition-all duration-300`}>
          <div className="flex items-center justify-between md:grid md:grid-cols-3 md:gap-4">
            ...
            <div className="flex items-center gap-2 md:justify-start">
              ...
              <div className="hidden md:flex items-center space-x-2">
                ...
                <div className="hidden lg:block">
                  <p className="font-semibold text-xs">¡Visítanos!</p>
                  <p className="text-xs text-blue-100">Tienda física</p>
                </div>
                <Button 
            ...
            {/* Ubicación de Tienda (Centro) */}
            <div className="flex justify-center md:flex">
              <div 
                onClick={() => window.open('https://maps.app.goo.gl/r27u2URmmAyWZyfv6', '_blank')}
              ...
              >
                <div className="text-center">
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <span className="font-bold text-white text-xs md:text-sm">¡Visítanos!</span>
                  </div>
                  <p className="text-blue-100 text-xs hidden md:block">Tienda física</p>
                </div>
              </div>
            </div>
              ...
              <div className="bg-gradient-to-r from-blue-500/20 to-indigo-600/20 rounded-xl p-4 border border-blue-500/30">
                <div className="text-center">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    <i className="fas fa-map-marker-alt text-red-400 text-lg"></i>
                    <h3 className="font-bold text-white text-sm">¡VISÍTANOS!</h3>
                  </div>
                  <p className="text-white/90 text-xs mb-3">
                    Encuentra los mejores productos tecnológicos en nuestra tienda física. ¡Te esperamos!
                  </p>
                  <button 
                    onClick={() => window.open('https://maps.app.goo.gl/r27u2URmmAyWZyfv6', '_blank')}
                    className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-2 px-4 rounded-lg text-sm font-semibold hover:from-blue-600 hover:to-indigo-700 transition-all duration-200"
                  >
