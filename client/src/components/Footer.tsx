...
export function Footer() {
  ...
  const rawShareUrl = 'https://maps.app.goo.gl/r27u2URmmAyWZyfv6';
  const mapsEmbedSrc = `https://www.google.com/maps/embed/v1/place?key=AIzaSyBFw0Qbyq9zTFTd-tUY6dOWTgaQzuU17R8&q=${encodeURIComponent('r27u2URmmAyWZyfv6')}`;
