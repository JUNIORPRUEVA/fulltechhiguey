    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{formatCurrency(activityStats.totalSpent)}</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{formatCurrency(activityStats.totalSavings)}</p>
          ...
          <Card className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 shadow-xl">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-blue-100 text-sm font-medium">Actividad Mensual</p>
                  <p className="text-3xl font-bold">{activityStats.monthlyActivity}</p>
                  <p className="text-blue-100 text-xs">acciones este mes</p>
                </div>
                <div className="bg-white/20 p-3 rounded-full">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-white/60 backdrop-blur-md rounded-xl shadow-lg border border-white/20">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="text-center p-4 bg-green-50 rounded-lg">
                        <p className="text-2xl font-bold text-green-600">{formatCurrency(activityStats.totalSavings)}</p>
                        <p className="text-xs text-gray-500">Ahorros Total</p>
                      </div>
                    </div>
                    <div className="pt-4">
                      <div className="text-center p-4 bg-blue-50 rounded-lg">
                        <p className="text-3xl font-bold text-blue-600">{formatCurrency(activityStats.totalSpent)}</p>
